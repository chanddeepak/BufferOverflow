...
namespace Nagarro.BufferOverflow.Shared
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public NagarroBufferOverflowValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, NagarroBufferOverflowValidationResult validationResult)
        {
            this.Data = data;
        ...
        public bool IsValid()
        {
            ...
            if (this.Data == null || HasValidationFailed() || HasExceptionOccurred())
            {
                result = false;
            }
        ...
        public bool HasValidationFailed()
        {
            ...
            {
                if (!String.IsNullOrWhiteSpace(this.Message) || ValidationResult != null)
                {
                    result = true;
                }
            }
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(NagarroBufferOverflowValidationResult validationResult)
        {
